...
// Main Landing Page (Switches between the locked Gear/Brain screen & the 3-button Dashboard)
app.get('/', (req, res) => {
    res.render('index');
});

// SUB-PORTAL: Events Portal Page (Protected by SSO check)
...
// SUB-PORTAL: Academic Updates Page (Protected by SSO check)
app.get('/academics', checkAuth, (req, res) => {
...
// SUB-PORTAL: Announcements Page (Protected by SSO check)
...
// Secure Administrator Control Board (With Multi-Table TABBED CRUD management)
